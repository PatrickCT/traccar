...
public class ServiceLocator extends org.apache.axis.client.Service implements com.unisolutions.Service {
    ...
    private java.lang.String ServiceSoap_address = "https://cloud-test.unigis.com/hub_TEST/mapi/soap/gps/service.asmx";
    ...
    public com.unisolutions.ServiceSoap getServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public com.unisolutions.ServiceSoap getServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.unisolutions.ServiceSoapStub _stub = new com.unisolutions.ServiceSoapStub(portAddress, this);
    ...
    private java.lang.String ServiceSoap12_address = "https://cloud-test.unigis.com/hub_TEST/mapi/soap/gps/service.asmx";
    ...
    public com.unisolutions.ServiceSoap getServiceSoap12() throws javax.xml.rpc.ServiceException {
        java.net.URL endpoint;
        try {
    ...
    public com.unisolutions.ServiceSoap getServiceSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.unisolutions.ServiceSoap12Stub _stub = new com.unisolutions.ServiceSoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.unisolutions.ServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.unisolutions.ServiceSoapStub _stub = new com.unisolutions.ServiceSoapStub(new java.net.URL(ServiceSoap_address), this);
                _stub.setPortName(getServiceSoapWSDDServiceName());
                return _stub;
            }
            if (com.unisolutions.ServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.unisolutions.ServiceSoap12Stub _stub = new com.unisolutions.ServiceSoap12Stub(new java.net.URL(ServiceSoap12_address), this);
                _stub.setPortName(getServiceSoap12WSDDServiceName());
                return _stub;
            }
