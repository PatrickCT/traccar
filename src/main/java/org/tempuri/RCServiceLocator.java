...
public class RCServiceLocator extends org.apache.axis.client.Service implements org.tempuri.RCService {

    public RCServiceLocator() {
    }

    public RCServiceLocator(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public RCServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }
